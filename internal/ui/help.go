...
func (m HelpModel) helpContent() []helpEntry {
	return []helpEntry{
		...
		{key: "Enter", desc: "Into — drill / focus next panel / commit"},
		{key: "Esc", desc: "Back — pop drill / close popup"},
		{isSection: true, text: "Table (Panel 2)"},
		{key: "/", desc: "Search / filter"},
		{key: "Space", desc: "Open row context menu"},
		{key: "Y", desc: "YAML of selected row"},
		{key: "E", desc: "Edit (kubectl edit)"},
		{key: "S", desc: "Shell into container"},
		{key: "D", desc: "Delete resource"},
		{key: ".", desc: "Toggle helm storage secrets (Secrets list)"},
		{isSection: true, text: "Detail (Panel 3)"},
		{key: "h / l", desc: "Previous / next tab"},
		{key: "[ / ]", desc: "Previous / next tab (alias)"},
		{key: "z", desc: "Toggle expand panel"},
		{isSection: true, text: "Relatives tab"},
		{key: "Enter", desc: "Drill into cursor ref"},
		{key: "Esc", desc: "Back one level"},
		{key: "Space", desc: "Open breadcrumb popup"},
		{key: "Y", desc: "YAML of cursor ref"},
		{isSection: true, text: "Helm Releases"},
		{key: "Space (Release)", desc: "Doc menu (Manifest/Notes/Values/Hooks)"},
		{key: "Space (History)", desc: "Rollback to selected revision"},
		...
		{key: "y", desc: "Copy focused panel content"},
		{key: "!", desc: "App log"},
		{key: "?", desc: "Toggle help"},
		{key: "q", desc: "Quit km8"},
		{isSection: true, text: "YAML popup"},
		{key: "E", desc: "Edit (kubectl edit)"},
		{key: "y", desc: "Copy full YAML"},
		{key: "/", desc: "Search inside YAML"},
		{key: "Esc", desc: "Close"},
		{isSection: true, text: "Popup menus"},
		{key: "j / k", desc: "Move cursor"},
		{key: "Enter", desc: "Commit choice"},
		{key: "Space / Esc", desc: "Close popup (mirror open)"},
